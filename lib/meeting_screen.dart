...
class _MeetingWidgetState extends State<MeetingWidget> {
  ...
  TextEditingController llamarA = TextEditingController();
  late Timer timer;
                ...
                child: Builder(
                  builder: (context) {
                    ...
                    return ElevatedButton(
                      ...
                      onPressed: () => {startMeeting(context, llamarA.text)},
  ...
  startMeeting(BuildContext context, token) {
    bool _isMeetingEnded(String status) {
      var result = false;
        ...
        zoom.onMeetingStatus().listen((status) {
          ...
          if (status[0] == "MEETING_STATUS_INMEETING") {
            zoom.meetinDetails().then((meetingDetailsResult) {
              ...
              PushNotification.sendPushMessage(token, meetingDetailsResult)
